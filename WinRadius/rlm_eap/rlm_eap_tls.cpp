...
static CONF_PARSER module_config[] = {
	...
	{ "cache", PW_TYPE_SUBSECTION, 0, NULL, (const char *) cache_config },

	{ "verify", PW_TYPE_SUBSECTION, 0, NULL, (const char *) verify_config },

#ifdef HAVE_OPENSSL_OCSP_H
	{ "ocsp", PW_TYPE_SUBSECTION, 0, NULL, (const char *) ocsp_config },
#endif
			       ...
			       char **ppath, int *pssl)
{
	...
	aia = (AUTHORITY_INFO_ACCESS *)X509_get_ext_d2i(cert, NID_info_access, NULL, NULL);
...
{
	VALUE_PAIR *vp = (VALUE_PAIR *)data_ptr;
	if (!data_ptr) return;
