...
static const CONF_PARSER serverdest_config[] = {
	{ "log", PW_TYPE_SUBSECTION, 0, NULL, 
		(const char *) logdest_config },
...
static const CONF_PARSER server_config[] = {
...
#endif
	{ "log", PW_TYPE_SUBSECTION, 0, NULL, (const char *) log_config_nodest },
	...
	{  "security", PW_TYPE_SUBSECTION, 0, NULL, (const char *) security_config },
...
static int r_mkdir(const char *part)
{
	...
	ptr = (char *)strrchr(part, FR_DIR_SEP);
...
int read_mainconfig(int reload)
{
	...
	if (mainconfig.radlog_dest == RADLOG_NULL) {
		...
		mainconfig.radlog_dest = (enum radlog_dest_t)fr_str2int(str2dest,(char *) radlog_dest,
						    RADLOG_NUM_DEST);
	...
	cc =(struct cached_config_t *) rad_malloc(sizeof(*cc));
