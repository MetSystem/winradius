...
//extern  lt_dlhandle lt_dlopen(const char *name);
//typedef lt_dlopenext lt_dlopen;
//extern void *lt_dlsym(lt_dlhandle handle, UNUSED const char *symbol);
...
static lt_dlhandle lt_dlopen(const char *name)
{
...
static void *lt_dlsym(lt_dlhandle handle, UNUSED const char *symbol)
{
	//wchar_t wcsname[MAX_PATH];
...
static int lt_dlclose(lt_dlhandle handle)
{
